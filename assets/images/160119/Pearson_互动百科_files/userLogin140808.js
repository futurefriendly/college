...
var common_login = {
	...
	setDefaultLoadInfo: function(tagObject){
	  ...
	  document.getElementById(tagObject).innerHTML = "<li class='log'><a target='_self' href='http://www.baike.com/' class='cwhite'>百科首页</a></li><li class='log' id='entry'><a target='_self' class='cwhite' onmousedown=\"document.domain='baike.com';var date=new Date();date.setTime(date.getTime()+24*3600*1000);document.cookie='nextURL='+encodeURIComponent((document.referrer.length&gt;0&amp;&amp;document.referrer!=window.location.href)?document.referrer:window.location.href)+';expire='+date.toGMTString()+';path=/;domain=.baike.com;'\" href='http://passport.baike.com/login.do?service="+nextUrl+"'>登录</a></li><li class='log bor-no' id='login'><a target='_self' href='http://passport.baike.com/user/userRegister.jsp' class='cwhite'>注册</a></li>";
	},
    displaceHtml: function(dataInfo, options) {
        ...
        if (typeof(dataInfo) != "undefined" && dataInfo != null) {
            ...
            if (noticeCount > 0) {
                ...
                noticeCountHtml = "(<em >" + noticeCount + "</em>)";
            }
...
var userNoticeDataInfo = {
    ...
    noticeUrl: {
		...
		"unReadBaikeNoticeCount": "<a href='http://i.baike.com/myMsgs.do?action=baikeNotice'  key='unReadBaikeNoticeCount' target='_blank' class='wh2'>行业百科回复$</a>",
